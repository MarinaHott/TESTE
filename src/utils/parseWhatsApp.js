...
function cleanLine(line) {
  // Remove U+200E, U+200F, U+FEFF, U+202A-U+202E invisible marks WhatsApp adds
...
// Strips timestamps — only "Nome: mensagem" to save ~30% tokens
export function formatForGroq(messages) {
